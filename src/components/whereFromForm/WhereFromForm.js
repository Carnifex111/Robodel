        ...
        <div className="form-container__adress">
          ...
          <div className="form-container__adress__inputs">
            ...
            {formik.errors.adress && formik.touched.adress ? (
              <div className="validate">{formik.errors.adress}</div>
            ) : null}
            {formik.errors.home && formik.touched.home ? (
              <div className="validate">{formik.errors.home}</div>
            ) : null}
          </div>
        </div>
        ...
        <div className="form-container__contacts">
          ...
          <div className="form-container__contacts__inputs">
            ...
            {formik.errors.lastName && formik.touched.lastName ? (
              <div className="validate">{formik.errors.lastName}</div>
            ) : null}
            <input
              className={`input-form ${
            ...
            {formik.errors.firstName && formik.touched.firstName ? (
              <div className="validate">{formik.errors.firstName}</div>
            ) : null}
            <input
              className={`input-form ${
            ...
            {formik.errors.phone && formik.touched.phone ? (
              <div className="validate">{formik.errors.phone}</div>
            ) : null}
          </div>
        </div>
      </div>
